...
| Layer | Length | Where |
|---|---|---|
| **Burn-in** | 8–12 words | Final frame of every video |
| **Caption block** | 2 sentences | Any caption mentioning price, rewards, or buying |
| **Full disclosure** | Paragraph | Bridge page, site footer, checkout — counsel-signed |

---

## What FTMO actually says

Their general disclosure, verbatim:
...
Their terms go further: *"We are not regulated by the Czech National Bank… you will not receive regulatory protection associated with the financial sector"* and *"the main purpose of our services is to provide you with educational experience… as well as to evaluate your performance."*
...
3. Not investment, legal, accounting, or tax advice
4. Not a broker, no deposits accepted
...
- Minimum **28px** at 1080×1920, white or `#f5f5f5` on the dark frame
- Hold on screen at least **3 seconds** — not a one-frame flash
- Keep clear of the bottom 250px (UI overlay) and never behind a caption block
- Never in gold on the blue gradient — contrast fails at thumbnail scale
...
## Marketing copy this obliges you to change

A disclaimer only holds if the product copy matches it. To use the language above, these need to move:

| Now | To |
|---|---|
| "Get Funded & Trade — Up to $1M Capital" | "Up to $1M **simulated** capital" |
| "90% Profit Split" as the headline | "Up to 90% reward split, on demand" |
| "funded account" | "simulated funded account" or "demo account" |
| Reward calculator with a projected dollar figure | Label as illustrative, or remove from the ad destination |

The pack already says "simulated" throughout — this is about the site catching up to it.
