# Scripts — 14 videos, ready to shoot

Founder-led, phone-shot, anti-hype. Each script carries its hook, VO, on-screen text, cover line, caption, hashtags, and whether it can run as a paid ad.

## Ground rules

**No prices spoken in any video.** No fees, sizes, discount percentages. Video sells the standard and the free trial; numbers live on statics and at checkout. This keeps clips usable after a price change.

**"Since May" is team background, not a slogan.** On camera it appears only on the objectives screen-record (script 5) or in an AMA answer if asked. Never a hook, caption lead, or end card.
...
5–8 per post, rotate — never paste the same block twice in a row. No earnings tags.

- **Set A — rules/education:** `#propfirm #tradingrules #riskmanagement #drawdown #tradingdiscipline #propfirmchallenge #forexeducation`
- **Set B — product/compare:** `#propfirm #fundedtrader #propfirmtrading #simulatedtrading #tradingjournal #tradersofinstagram`
- **Set C — community/founder:** `#propfirm #tradingcommunity #foundersstory #tradersofinstagram #buildinpublic #verodus`
...
Destination is off-platform and the hook is a discount code — weak paid intent, and code-gating invites review.
...
**Cover:** `w1-discord.png` channel panel — `FOUNDERS ANSWER DAILY`

**Caption** (Set C)

> Rules channel, support, founders in the chat. Not a bot. Not a ticket queue.
>
> Intro details and the code are in there. Ask before you pay — link in bio.

**Pinned Discord welcome**

> Verodus has been operating since May. This is the founding community for the public series.
>
> Instant, 1-Step, Lite, Pro — rules in #rules, same as the site. Founders are in here daily.
>
> Free trial: verodus.com. Code VERO35 at checkout. We do not post fake payouts; real certificates go in #payout-proof.
...
**20–30s · Ad · CTA: Learn More**

Screen-record the live objectives page. Chips `w2-chip-1…3.png`. The most compliance-positive asset in the pack, and the only script that says "since May" on purpose — the date proves the page predates the video.

**Hook:** "Don't trust a firm's ad. Trust its objectives page."
...
**On-screen:** gold circle on each rule as it's named
**Cover:** objectives page with a gold circle on "No time limit" — `READ IT YOURSELF`

**Caption** (Set A)

> No time limit. Static max drawdown on 2-Step. Fee back on your first reward — evaluations only.
>
> All of it on the objectives page, same as it's been since May. No PDF, no support ticket.
>
...
**Cover:** `w3-ama-thumb.png` — `ASK US ANYTHING`

**Caption** (Set C)

> Four questions we get every week, answered flat: are the rules public, how do rewards work, why is Instant priced differently, and why should you believe us.
>
...
**Hook:** "This is the part where most firms start shouting."
...
Montage implies social proof we can't substantiate ad-side. Frames `w4-montage-open.png` → footage → `w4-montage-end.png`. No payout figures.
...
**Cover:** `w4-montage-open.png` — `PUBLIC RULES. REAL ROOM.`
...
> No rented testimonials. No screenshots we can't stand behind.
>
> The trial costs you an afternoon.
...
If pricing isn't changing: `THE RULES AREN'T CHANGING. NEITHER IS THE TRIAL.`
**Cover:** `w4-lastchance.png` — `LAST CALL`
...
**20s · 46 words · Ad · CTA: Learn More**

Never pair with static-drawdown or fee-refund copy.

**Hook:** "Instant skips the evaluation. Here's the catch."
...
**Cover:** founder, one finger up on "the catch" — `INSTANT: THE CATCH`

**Caption** (Set B)

> Instant skips the evaluation. No profit target — you trade from day one.
>
> The honest part: max loss trails, and Instant doesn't refund the fee. Evaluations do. That's the trade.
>
...
**Hook:** "A one-step with every number published before you pay."
...
**On-screen:** `EVERY NUMBER, PUBLISHED` → `NO TIME LIMIT` → `FEE BACK ON FIRST REWARD`
**Cover:** objectives page, target row highlighted — `EVERY NUMBER, PUBLISHED`
...
- "We've been running since May" as a hook, caption lead, or end card
...
**Office 2 — glass meeting room.** Reads as a working company rather than a set. The table edge gives the frame a foreground anchor without putting anything reviewable in it.

> Photorealistic empty glass-walled meeting room as a backdrop for a vertical 9:16 video, eye level, 35mm full-frame look at f/2, background softly out of focus. Evening interior. A dark matte navy feature wall in near-black indigo (#07003B) deepening to royal navy (#1B2B8E) fills the left two-thirds; on the right, a floor-to-ceiling glass wall with a slim black frame and a warm champagne-gold light strip running along the ceiling line behind it. Beyond the glass, an unlit corridor with two small warm downlights, heavily blurred to soft bokeh. The far corner of a matte black conference table enters the bottom left of frame, empty and bare. No monitors, no televisions, no laptops, no screens of any kind, no whiteboard, no charts, no graphs, no numbers, no text, no logos, no people. Centre and lower two-thirds otherwise empty. Soft key from upper left, clean shadow detail, no vignette. Premium, editorial, restrained colour, cinematic grade, fine natural film grain.

**Office 3 — corridor threshold.** The most depth of the set, and the most flattering: the receding corridor puts a dark tunnel behind your head so the face separates without a rim light.

> Photorealistic empty modern office corridor as a backdrop for a vertical 9:16 video, eye level, 35mm full-frame look at f/2, strong depth with the far end softly out of focus. Evening interior. Dark matte navy walls, near-black indigo (#07003B) shifting to royal navy (#1B2B8E), receding into near darkness at the far end. A continuous warm champagne-gold LED reveal runs along the base of the right-hand wall, and one small warm sconce glows halfway down. Polished dark concrete floor with a soft reflected highlight. Absolutely empty — no furniture, no monitors, no screens, no signage, no artwork, no charts, no numbers, no text, no logos, no people. Soft key from the upper left. No vignette. Calm, premium, editorial, cinematic grade, low contrast in the shadows, fine natural film grain.

**Office 4 — slatted wood reception.** The warmest of the four. Best if your shirt is dark; the wood reads as expensive without reading as a hotel lobby.

> Photorealistic empty office reception area as a backdrop for a vertical 9:16 video, eye level, 35mm full-frame look at f/2, background softly out of focus. Evening interior. A full-height feature wall of slim vertical dark walnut slats fills the left and centre, lit from a concealed warm champagne-gold source at its base so the slats cast fine soft shadows. To the right, a deep matte navy plaster wall in near-black indigo (#07003B) to royal navy (#1B2B8E), and a dark opening leading to an unlit space beyond. The corner of a low stone bench enters the bottom left, bare. No reception desk in frame, no monitors, no televisions, no screens of any kind, no signage, no charts, no numbers, no text, no logos, no plants, no people. Centre and lower two-thirds empty. Soft key from the upper left, clean shadow detail, no vignette. Premium, editorial, warm but restrained, cinematic grade, fine natural film grain.

**Office 5 — daylight version.** Use this one if you're shooting in the morning by a window; a night-lit backdrop behind a daylight-lit face never matches.

> Photorealistic empty modern office lounge as a backdrop for a vertical 9:16 video, eye level, 35mm full-frame look at f/2, background softly out of focus. Overcast morning daylight from a large window off frame left, soft and directional. A deep matte navy wall in near-black indigo (#07003B) to royal navy (#1B2B8E) on the left, and on the right a frosted glass partition glowing softly with diffuse daylight, no view or detail visible through it. Furniture limited to the far corner of a low walnut credenza at the edge of frame. No monitors, no computers, no televisions, no screens of any kind, no charts, no graphs, no numbers, no text, no logos, no people. Centre and lower two-thirds completely empty. Gentle falloff, clean shadow detail, no vignette. Calm, premium, editorial, restrained colour, natural cinematic grade, fine film grain.

**Studio.** The fallback if the real office is small or cluttered. More controllable, but it reads more like a set.
...
Say the exclusions out loud in every one of these. Image models put monitors and rising charts into anything that reads as a finance or trading set unless told not to, and that is the one thing this backdrop cannot have. Naming the room type first — lounge, corridor, reception — does more work than the negative list, because a model asked for "an office" reaches for desks before it reads the exclusions.

Never a bookshelf, never a night-city skyline window, never a green screen with a composited office behind it. All three are the visual signature of the people this brand is trying not to resemble.
