(function () {
  ...
  var ADDONS = [
    ...
    },
    {
      ...
      tooltip: function () {
        return 'On Demand Rewards with 90% Split\n\nRequest your 90% reward share with no 7- or 14-day wait. Minimum reward $100.\n\n'
          + minDaysCopy();
      }
    }
  ];
  ...
  function minDaysCopy() {
    if (selectedPlan === 'instant') {
      return 'Weekly / Bi-Weekly / On-Demand: $100 and Best Day ≤20% of Positive Days’ Profit. Instant has no minimum trading days.';
    }
    if (selectedPlan === '1step') {
      return 'Weekly / Bi-Weekly / On-Demand: $100 and Best Day ≤50% of Positive Days’ Profit. 1-Step has no minimum trading days.';
    }
    return 'Weekly / Bi-Weekly / On-Demand: $100 and 3 trading days.';
  }
