(function () {
  ...
  var PRICING = {
    ...
    '2steplite': {
      label: '2-Step Lite',
      sizes: {
        '5000': { price: 75 }, '10000': { price: 91 }, '25000': { price: 152 },
    ...
    '2steppro': {
      label: '2-Step Pro',
      sizes: {
        '5000': { price: 85 }, '10000': { price: 106 }, '25000': { price: 168 },
  ...
  var ADDONS = [
    {
      ...
      tooltip: function () {
        return 'Exempts all open positions from the 22:00 UTC Friday liquidation rule so you may hold through the weekend on evaluation and funded accounts. Perfect for swing traders, position traders, and multi-day strategies.\n\n'
          + 'News trading is included on every plan — this add-on is only weekend holding.';
      }
    },
    {
      id: 'weekly-payout',
