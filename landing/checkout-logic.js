(function () {
  ...
  var PRICING = {
    instant: {
      label: 'Instant',
      sizes: {
        '5000': { price: 75 }, '10000': { price: 106 }, '25000': { price: 214 },
    ...
    '1step': {
      label: '1-Step',
      sizes: {
        '5000': { price: 55 }, '10000': { price: 92 }, '25000': { price: 185 },
        '50000': { price: 297 }, '100000': { price: 515 }, '200000': { price: 1006 }
      }
    },
    '2steplite': {
      label: '2-Step Lite',
      sizes: {
        '5000': { price: 65 }, '10000': { price: 85 }, '25000': { price: 145 },
        '50000': { price: 229 }, '100000': { price: 414 }, '200000': { price: 768 }
      }
    },
    '2steppro': {
      label: '2-Step Pro',
      sizes: {
        '5000': { price: 69 }, '10000': { price: 91 }, '25000': { price: 146 },
        '50000': { price: 245 }, '100000': { price: 445 }, '200000': { price: 888 }
      }
    }
  };
  ...
  var BUNDLES = [
    {
      name: 'Swing',
      ids: ['news-trading', 'weekend-holding'],
  ...
  var ADDONS = [
    {
      ...
      label: 'News Trading',
      pct: 0.12,
      desc: 'Trade NFP, FOMC, CPI, earnings and geopolitical events with zero restrictions',
      tooltip: function () {
        var swing = bundleOnName('Swing')
          ? 'You also have Weekend Holding on — both are billed as Swing, not as two add-ons.'
          : 'Pair with Weekend Holding to hold through news and weekends as Swing — billed as one add-on, not two.';
        return 'Unlock unrestricted news trading on evaluation and funded accounts. Trade high-impact events like NFP, FOMC, CPI, earnings releases, and geopolitical news with zero restrictions. Perfect for event-driven strategies.\n\n'
          + 'Default funded accounts pause around high-impact news. This add-on turns that window off.\n\n'
          + swing;
      }
    },
    {
      ...
      tooltip: function () {
        var swing = bundleOnName('Swing')
          ? 'You also have News Trading on — both are billed as Swing, not as two add-ons.'
          : 'Pair with News Trading to hold through news and weekends as Swing — billed as one add-on, not two.';
