...
> © 2026 Verodus L.L.C.-FZ. Trading is simulated. Evaluation fees are service fees. Performance rewards are paid in cash according to the published program rules after eligibility and identity checks.  
...
| Step | Now | Change to |
|---|---|---|
| 1 | Choose your program | Choose Instant or a challenge |
| 2 | Prove consistency | Trade the published rules |
...
**Now:** Verodus is a proprietary trading evaluation firm. Traders demonstrate consistency in a simulated, market-referenced environment against published objectives. Successful traders can unlock measured performance rewards — without depositing trading capital.

**Instead:** Verodus is a simulated trading evaluation. You pay a fee, trade a demo that follows live market prices, and follow published risk rules. If you qualify, we pay you a cash reward based on that simulated result. You do not deposit trading capital and we are not a broker.

### Is Verodus legitimate?

**Now:** Verodus is not a brokerage or investment firm. Trading is simulated. Evaluation fees are service fees. Performance rewards are discretionary payments based on simulated results. Review the Terms, Risk Disclosure, and Trustpilot feedback, and only participate if you understand the model.
