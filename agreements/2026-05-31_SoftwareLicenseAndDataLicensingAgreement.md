...
A. 1591011 B.C. LTD. is a company incorporated under the laws of British Columbia, Canada and is the owner and operator of certain pre-existing proprietary software, CRM systems, and related technology (collectively, the "Software").

B. LLC-FZ is a Meydan free-zone company registered in Dubai, United Arab Emirates, with licenses to carry on the following business activities:

i. 6202.91 – Information Technology Consultants;

ii. 7020.00 – Management Consultancy Activities;

iii. 6311.92 – Data Classification & Analysis Services.
...
(b) Its execution and performance will not violate any other agreement to which it is bound; and
...
8.2 Either party may terminate the Agreement immediately upon written notice for material breach if the breach is not cured within thirty (30) days of written notice, delivered by registered mail to the company's registered and records office.
