# OPERATIONAL SERVICES, DOMAIN USAGE AND EVALUATION RIGHTS AGREEMENT

Between

**Verodus Capital Inc.**  
("Capital" or "Service Provider")
...
A. Capital is a company incorporated under the laws of British Columbia, Canada.

B. LLC-FZ is the registered owner of the domain name verodus.com.
...
D. The parties will each establish and operate their own isolated payment-processor merchant accounts with no crossover or commingling of funds between entities.

E. LLC-FZ grants to Capital the right to use the Domain, the right to conduct platform evaluations, and the right to use LLC-FZ's affiliate software as part of traffic-driving services.
...
1.1 "Domain" means the domain name verodus.com.
...
## 2. SERVICES TO LLC-FZ AND CAPITAL'S INDEPENDENT ACTIVITIES

2.1 Capital shall provide the following Services to LLC-FZ:
...
2.2 Capital shall independently perform, for its own account and on its own behalf (and not as a service to LLC-FZ):

(a) Full payment processing, including pay-ins, rewards, refunds, and banking services through merchant accounts held solely in Capital's name; and

(b) Platform evaluations.
...
(a) LLC-FZ shall, in its own name and for its own account, perform all KYC of Domain users.

(b) Capital shall not perform KYC for LLC-FZ, shall not collect identity documents or KYC files on LLC-FZ's behalf, and is not LLC-FZ's KYC provider, outsourced compliance function, or KYC processor.
...
(d) Capital may collect and process payment-instrument, fraud-prevention, sanctions, and settlement data on its own payment rails as required by its processors and applicable law. That activity is Capital's own payment-rail compliance. It is not KYC performed for LLC-FZ.

## 3. DOMAIN AND EVALUATION RIGHTS

3.1 LLC-FZ hereby grants Capital a non-exclusive, non-transferable, revocable license to use the Domain, conduct platform evaluations, and use LLC-FZ's affiliate software solely for the purpose of marketing, traffic-driving, and operating the platform during the Term.

3.2 Capital shall not sublicense or transfer the Domain or the affiliate software.

3.3 In exchange for the rights granted in this Section 3, Capital shall:

(a) Drive traffic to the Domain;

(b) Provide the Services described in Section 2.1; and

(c) Perform the independent activities described in Section 2.2.
...
5.1 Within six (6) months after the Effective Date, the parties shall mutually agree upon subscription targets for the following thirty (30) month period.
...
(b) Its performance will not breach any other agreement; and
...
6.2 LLC-FZ represents that it, and not Capital, is responsible for KYC of Domain users.
...
8.1 This Agreement commences on the Effective Date and continues for thirty-six (36) months (the "Term").

8.2 Either party may terminate the Agreement for material breach, provided the breach is not cured within thirty (30) days of written notice delivered by registered mail to the company's registered and records office.
...
10.1 Neither party shall be liable for indirect, consequential, or punitive damages.

## 11. GOVERNING LAW AND DISPUTE RESOLUTION

11.1 This Agreement shall be governed by the laws of British Columbia, Canada, and the federal laws of Canada applicable therein.
