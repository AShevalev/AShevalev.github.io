...
ADDON_MENU = (
    ...
    (
        ...
        "Receive your 70% reward share every week. Default is Bi-Weekly 80%. Minimum reward $100. Instant: no min trading days; Best Day ≤20% (a counted day is a green day of at least 0.5% of start-of-day equity). 1-Step: no min trading days; Best Day ≤50%. 2-Step: 3 trading days.",
    ),
    (
        "On Demand Rewards with 90% Split", "32%", "15%",
        "Withdraw your profit share anytime — no waiting for fixed cycles",
        "Request your 90% reward share anytime after you meet that plan’s payout rule — no waiting for a 7- or 14-day cycle. Minimum reward $100. Instant: $100 and Best Day ≤20% (green day of at least 0.5% of start-of-day equity); no min trading days. 1-Step: $100 and Best Day ≤50%; no min trading days. 2-Step: $100 and 3 trading days.",
    ),
    (
...
def build_rules():
    ...
    story.append(P(
        ...
        "Best Day ≤20% (a counted day is a green day of at least 0.5% of that day’s start-of-day equity). "
