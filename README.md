...
Installable Verodus web app with an **Add to Home Screen** CTA that works from any mobile browser.

Open the site on a phone and tap **Add to Home Screen**:

- **Chrome, Edge, Samsung, Opera** — native install prompt
