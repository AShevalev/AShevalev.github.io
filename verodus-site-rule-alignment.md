...
**Superseded for edits.** Use `verodus-rule-alignment.md`. Instant QPP is **5 min trading days** (simple, first and later). Instant Best Day is **20%** and only days with **more than 0.5%** count. 1-Step / 2-Step QPP payouts need **3 trading days**.
