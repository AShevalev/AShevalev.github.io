...
| Confirm the number (separate) | `13-draft-email-confirm-number.md` — standing cash price for 60%; $1m / $600k labelled as an example; asks whether the option is exercisable at six months, twelve months, or in a window between; no Verodus ask |
