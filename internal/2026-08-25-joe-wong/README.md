...
| Confirm the number (send this) | `15-draft-email-clarify-and-probe.md` — restates the majority number; does not restate his 6–12 month sequence; cash and hold-open terms implied; one explicit question: later completion vs later choice. No Verodus ask |
