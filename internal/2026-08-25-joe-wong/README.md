...
| Confirm the number (send this) | `15-draft-email-clarify-and-probe.md` — majority number only; amount in the 51–60% range; complete vs choose before going to holders. Leaves room for a later option premium and integration fee without naming either. No Verodus ask |
