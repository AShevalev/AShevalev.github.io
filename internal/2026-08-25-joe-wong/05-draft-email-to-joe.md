...
David was in-house on marketing from April until June. Wages for those two months were $8,000. He will return part-time next month to handle marketing. We also plan to sign an intern at approximately $3,000 a month for marketing and customer support.
...
LLC-FZ licences Capital to use the domain, run platform evaluations, and use affiliate tools to drive traffic. Capital provides marketing directed to the domain and processes payments on merchant accounts in Capital’s own name. Capital does not perform KYC. Each party keeps isolated merchant accounts; there is no commingling. Capital has no access to LLC-FZ’s software beyond the affiliate-tool licence, and no control of LLC-FZ’s merchant accounts. There are no invoices between them unless LLC-FZ, at its discretion and on 90 days’ notice, charges a 5% royalty on Capital’s gross sales (CAD), paid quarterly. The term is 36 months. British Columbia law; BCICAC arbitration in Vancouver. Signed by Kim Chen for both companies.

The two agreements are independent of each other. They can be varied if that is what this endeavour requires. I would be grateful if your counsel would review the chart and these contracts and come back on the contracting party they prefer.
