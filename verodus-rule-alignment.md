...
- Cycle (same for the first payout and every payout after). **$100** on every cycle:
  - **Weekly (every plan):** `$100` and 7 calendar days since the account start or last reward. Always name `$100` on this bullet.
  - **Bi-weekly (every plan):** `$100` and 14 calendar days since the account start or last reward. Always name `$100` on this bullet.
  ...
  - **Instant on-demand:** `$100`. No min trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with **more than 0.5% profit**.
...
Do **not** write “green day.” Do **not** write “0.5% parameter.”
- Best Day ≤20% of **Positive Days’ Profit**. Every profitable day is included.
- On Instant **On-Demand** and the Instant Best Day modal only, explain 0.5% in plain language: **a profitable day is a day that closes with more than 0.5% profit**.
...
- Instant Best Day stays **20% of Positive Days’ Profit**. 0.5% is Instant On-Demand / Best Day modal only: a profitable day is a day that closes with more than 0.5% profit.
...
<ul>
  ...
  <li>On-demand on Instant: $100. No minimum trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit</li>
  <li>On-demand on 1-Step: $100. No minimum trading days. Best Day ≤50% of Positive Days’ Profit</li>
...
**Instant paste — Rewards & Payouts on `instant.html` (and Instant FAQ).** Keep Eligibility short. Weekly and Bi-Weekly still carry the Instant qualifying parameters (`$100` + Best Day ≤20% + the calendar clock). Put 0.5% on On-Demand / Best Day modal only. Do **not** say “Qualified Performance Account” on Instant (funded from day one). Do **not** write “green day” or “0.5% parameter.”

Do **not** dump Weekly / Bi-Weekly / On-Demand into Eligibility. Do **not** repeat the cycle list in Payout Frequencies **and** Performance Reward Split **and** Rewards. Frequencies = split + clock. Split card = 80% included / 70% and 90% may stack. Rewards = qualifying checklist.
...
Weekly (Add-on): $100, 7 calendar days, Best Day ≤20% of Positive Days’ Profit.

Bi-Weekly (Standard): $100, 14 calendar days, Best Day ≤20% of Positive Days’ Profit.

On-Demand (Add-on): $100. No minimum trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit.
```
...
1-Step Weekly / Bi-Weekly / On-Demand (same page, separate bullets — qualifying parameters on every cycle):

```text
Weekly (Add-on): $100, 7 calendar days, Best Day ≤50% of Positive Days’ Profit.
Bi-Weekly (Standard): $100, 14 calendar days, Best Day ≤50% of Positive Days’ Profit.
On-Demand (Add-on): $100. No minimum trading days. Best Day ≤50% of Positive Days’ Profit.
```
...
Weekly (Add-on): $100, 7 calendar days, and 3 trading days.
Bi-Weekly (Standard): $100, 14 calendar days, and 3 trading days.
On-Demand (Add-on): $100 and 3 trading days.
```
...
`instant.html` Eligibility is wrong today. It still uses the 1-Step / 2-Step QPP **3 trading days** sentence. Instant has **no minimum trading days**. Instant’s day rule is **20% Best Day of Positive Days’ Profit**. Same first payout and every payout after. Weekly and Bi-Weekly keep `$100` **and** Best Day ≤20%. Put 0.5% on On-Demand only.

| Key | Live | Change to |
|---|---|---|
| Eligibility | At least **3 trading days** since QPP; or one long bullet that dumps cycle + 0.5% | Short Eligibility: `$100` + Best Day ≤20% of Positive Days’ Profit + cycle. No min trading days. No 0.5% here. Do not dump Weekly / Bi-Weekly / On-Demand into this bullet. |
...
| On-Demand | Wordy 0.5% “parameter” + “green day”; or two On-Demand bullets | **One line:** `$100`. No min trading days. Best Day ≤20% of Positive Days’ Profit. **A profitable day is a day that closes with more than 0.5% profit.** |
...
|---|---|---|---|
| Instant | No eval. Funded from day one. | **No min trading days.** **20% Best Day of Positive Days’ Profit.** **No** 3-day QPP min. | Weekly **$100** + 7 calendar + Best Day ≤20% / bi-weekly **$100** + 14 calendar + Best Day ≤20% / on-demand **$100** + Best Day ≤20%. Instant on-demand: a profitable day is a day that closes with more than 0.5% profit. |
...
```html
<ul>
  <li>Instant: No evaluation phase. No minimum trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit.</li>
...
<ul>
    ...
    <li>On-demand Instant: $100. No minimum trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit</li>
...
<ul>
  ...
  <li>On Instant: no minimum trading days; Best Day ≤20% of Positive Days’ Profit (a profitable day is a day that closes with more than 0.5% profit)</li>
...
```text
Instant has no minimum trading days. Every Instant payout (first and later) needs $100, Best Day ≤20% of Positive Days’ Profit, and the selected cycle (weekly, bi-weekly, or on-demand). Instant On-Demand: a profitable day is a day that closes with more than 0.5% profit.
```
...
### Instant 20% Best Day modal — 0.5% profit of a day

Add this only when the tab / page is Instant. Do not write “0.5% parameter.”
...
```text
Every profitable day is factored into Positive Days’ Profit and Best Day. A profitable day is a day that closes with more than 0.5% profit. Small profitable days still count toward Positive Days’ Profit.
```
...
```javascript
if (isInstant) {
  contentEl.innerHTML += `<p>Every profitable day is factored into Positive Days’ Profit. A profitable day is a day that closes with <strong style="color:${gold}">more than 0.5% profit</strong>. Small profitable days still count toward Positive Days’ Profit and Best Day.</p>`;
}
```
...
- `content.li15`: 0.5% is Instant On-Demand only: a profitable day is a day that closes with more than 0.5% profit.
...
| Instant on-demand / “Anytime after min trading days” | Instant: `$100`. No min trading days. Best Day ≤20% of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit. 1-Step: `$100`. No minimum trading days. Best Day ≤50% of Positive Days’ Profit. 2-Step: `$100` + 3 trading days. |
...
| Page | Apply |
|---|---|
| `instant.html` | **No min trading days.** 20% Best Day of Positive Days’ Profit in the Best Day block **and** modal. Weekly / Bi-Weekly: `$100` + Best Day ≤20% + clock. 0.5% is On-Demand only: a profitable day is a day that closes with more than 0.5% profit. Drop 5-valid-day lines and the 3-day QPP Eligibility sentence. |
...
| `faq-plans.html` `p7` | Instant: no min trading days. 20% Best Day of Positive Days’ Profit. A profitable day is a day that closes with more than 0.5% profit. |
