...
- **Trading** — modal with instructions + **Open TradeHub** (`https://trade.verodus.com/dashboard`). No auto-install. Optional second app; skip the trade iframe until you want it.
